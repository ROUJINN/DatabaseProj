...
# --- Terminals ---
TERMINALS = [
    {"terminal_id": "T001", "merchant_name": "农园", "category": "canteen", "charge_rule": "normal", "manager_dept": "后勤部"},
    {"terminal_id": "T002", "merchant_name": "学五", "category": "canteen", "charge_rule": "normal", "manager_dept": "后勤部"},
    {"terminal_id": "T003", "merchant_name": "物美超市", "category": "supermarket", "charge_rule": "discount10", "manager_dept": "校务部"},
    {"terminal_id": "T004", "merchant_name": "文印店", "category": "printing", "charge_rule": "normal", "manager_dept": "校务部"},
    {"terminal_id": "T005", "merchant_name": "公共浴室", "category": "public", "charge_rule": "normal", "manager_dept": "后勤部"},
    {"terminal_id": "T006", "merchant_name": "家园", "category": "public", "charge_rule": "normal", "manager_dept": "校务部"},
    {"terminal_id": "T007", "merchant_name": "学一", "category": "canteen", "charge_rule": "normal", "manager_dept": "后勤部"},
    {"terminal_id": "T008", "merchant_name": "文创店", "category": "shopping", "charge_rule": "discount5", "manager_dept": "校务部"},
]
...
for s in students:
    # 每个学生可访问自己系的建筑
    dept_buildings = [pid for pid, (bname, _) in enumerate(BUILDINGS, 1) if random.choice([True, False])]
...
while current_date <= END_DATE:
    for person in all_people:
        ...
        if person.get("sid"):  # student
            person_rights = [ar for ar in ACCESS_RIGHTS if ar["role_type"] == "student" and ar["role_value"] == person["sid"]]
        else:  # faculty
            person_rights = [ar for ar in ACCESS_RIGHTS if ar["role_type"] == "faculty" and ar["role_value"] == person["fid"]]
